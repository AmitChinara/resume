...
const skills_data = new Set([`Java8`, `Spring Boot`, `Oracle DB`, `MongoDB`, `HTML`, `CSS`, `JavaScript`, `TypeScript`, `React JS`, `Bootstrap`, `Maven`, `JUnit`, `Node JS`, `Jest`, `Python`, `Linux Script`, `Git`]);
